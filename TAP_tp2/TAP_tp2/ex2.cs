...
namespace TAP_tp2
{
	public class ex2
	{
		...
		public static Click onClick = (o, args) => { if(.Sensitive){ Console.WriteLine("I am MEEEE", o);}};
...
*/
		public static void Main() {
			...
			ping.Sensitive=true;
			ping.Clicked += new EventHandler(onClick);
			...
			pong.Sensitive=true;
			pong.Clicked += new EventHandler(onClick);
